...
@Autonomous(name = "Auto TEST (Time-Based)", group = "Autonomous")
public class AutoTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        strafeForTime(1000, 0.5);   // strafe right for 1.0s
        driveForTime(1500, 0.5);    // drive forward for 1.5s
        rotateForTime(800, 0.25);   // rotate in place for 0.8s
